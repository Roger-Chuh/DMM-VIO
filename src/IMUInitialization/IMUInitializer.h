...
// - IMUInitializerTransitions define when to transition between which states
// (there are multiple transition models e.g. for ablation studies).
// - IMUInitializerLogic contains the main member variables and logic for
// calling the correct optimizers.
