...
public:
  ...
  explicit UCMRTPTHCamera(CamId camera_id, int width, int height)
  ...
  // s3, s4
  UCMRTPTHCamera(CamId camera_id, int width, int height,
                 const number_t *parameters, const int &level)
