 ...
 *codes. Copyright (C) Cihan Topal & Cuneyt Akinlar E-mails of the authors:
 *cihantopal@gmail.com, cuneytakinlar@gmail.com
 *
 ...
 *23(6), 862-872, doi:10.1016/j.jvcir.2012.05.004 (
 *
 * [2] C. Akinlar and C. Topal, “EDPF: A Real-time Parameter-free Edge Segment
 *Detector with a False Detection Con International Journal of Pattern
 *Recognition and Artificial Intelligence, 26(1), doi:10.1142/S0218001412550
 *
 * [3] C. Akinlar, C. Topal, "ColorED: Color Edge and Segment Detection by Edge
 *Drawing (ED)," submitted to the Journal of Visual Communication and Image
 *Representation (2017).
 **************************************************************************************************************/
