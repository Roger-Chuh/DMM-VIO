...
namespace dmvio {
// Contains logic how to integrate IMU data into the coarse tracking (see
// CoarseTracker.h) To this end it changes the optimized variables from the
...
public:
  ...
  // ------------------------------
  // Called by CoarseTracker (at the moment they are forwarded through
  // IMUIntegration):
  ...
  Sophus::SE3d computeCoarseUpdate(const dso::Mat88 &H, const dso::Vec8 &b,
