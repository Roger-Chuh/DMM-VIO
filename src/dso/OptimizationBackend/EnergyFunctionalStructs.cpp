...
{//TODO welcome FEJ
	std::swap<RawResidualJacobian*>(J, data->J);//TODO 确实是把刚计算的给拿过来了
//! 图像导数 * 图像导数 * 逆深度导数
...
void EFResidual::fixLinearizationF(EnergyFunctional* ef)
{
	...
	for(int i=0;i<patternNum;i+=4)
	{
        ...
        //TODO J->resF 是最新状态下的残差，并不是fej状态下的残差，现在要把残差恢复到fej状态，（所以用减号），如果打印出来会发现恢复到fej状态的残差后，残差会变大
		...
		_mm_store_ps(((float*)&res_toZeroF)+i, rtz);//TODO 存储在res_toZeroF
