...
// scale H and b.
        /// H is a 8*8 matrix, the 8 rows are for 8 different directions (scratch that , it's obvious that H_out is an arrow shaped matrix)
...
//[ ***step 2.2*** ] 使用增量更新后, 重新计算能量值
			...
			if(accept)
			{
                ...
                //TODO 这里用了fej吗? i guess not, it's just coaseTracking, far from fixed lag smoothing
