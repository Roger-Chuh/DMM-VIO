...
// This is a delayed graph. It has a delay (can also be 0) and maxGroupInGraph
...
class DelayedGraph {
 ...
 protected:
  ...
  // delayedValues contain the baEvalValues, meaning FEJValues for DSO
...
// commands in the right order. It can be used to "reconnect" a DelayedGraph
...
class DelayedMarginalizationGraphs : public BAGraphs {
 public:
  ...
  // like addMainGraph, but also delete old main graph. delayedGraph must not be
  // in the delayedGraphs yet!
