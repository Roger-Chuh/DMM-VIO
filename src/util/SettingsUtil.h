...
// These can call SettingsUtil::registerArg to register their members as
// settings. Registered settings can be set with commandline arguments or with
// yaml-files (see methods of SettingsUtil). Can also create settings which can
