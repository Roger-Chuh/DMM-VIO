#ifndef GRID_TARGET_BASE_HPP
#define GRID_TARGET_BASE_HPP
 ...
 * The target is supposed to be square such that each row has the same number of
 * points. Points along a row are supposed to be nominally colinear. Points
 * along a column are supposed to be nominally colinear. Missing points are not
 * allowed.
 *
 */
