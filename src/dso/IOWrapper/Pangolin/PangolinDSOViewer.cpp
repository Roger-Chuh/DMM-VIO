...
void PangolinDSOViewer::run()
{
	...
	pangolin::Var<int> settings_nMaxFrames("ui.maxFrames",setting_maxFrames, 10,15, false);
    // pangolin::Var<int> settings_nMaxFrames("ui.maxFrames",setting_maxFrames, 20,40, false);
