...
class GenericMember {
 public:
  ...
  GenericMember& operator=(GenericMember&& rhs) RAPIDJSON_NOEXCEPT { return *this = static_cast<GenericMember&>(rhs); }
#endif
 ...
 private:
  ...
  void DoReserveMembers(SizeType newCapacity, Allocator& allocator) {
    ...
    if (newCapacity > o.capacity) {
      ...
      Map **oldMap = oldMembers ? &GetMap(oldMembers) : 0, *&newMap = DoReallocMap(oldMap, newCapacity, allocator);
