...
// Used to store (addFrame) and retrieve (getImageAndIMUData) images and
...
public:
  ...
  // Adds a new image and corresponding IMU data to the queue. Can be called in
  // a different thread than the calls to getImageAndIMUData.
