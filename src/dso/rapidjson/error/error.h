...
enum ValidateErrorCode {
  ...
  kValidateErrorUniqueItems,      //!< Array has duplicate items but 'uniqueItems' is
                                  //!< true.
  kValidateErrorAdditionalItems,  //!< Array has additional items that are not
                                  //!< allowed by the schema.

  kValidateErrorMaxProperties,         //!< Object has more members than 'maxProperties'
                                       //!< value.
  kValidateErrorMinProperties,         //!< Object has less members than 'minProperties'
                                       //!< value.
  kValidateErrorRequired,              //!< Object is missing one or more members required by
                                       //!< the schema.
  ...
  kValidateErrorReadOnly,  //!< Property is read-only but has been provided when
                           //!< validation is for writing
  kValidateErrorWriteOnly  //!< Property is write-only but has been provided when
                           //!< validation is for reading
};
...
enum SchemaErrorCode {
  ...
  kSchemaErrorStartUnknown,         //!< Pointer to start of schema does not resolve to
  ...
  kSchemaErrorRefPointerInvalid,    //!< $ref fragment is not a valid JSON pointer
                                    //!< at offset
  kSchemaErrorRefUnknown,           //!< $ref does not resolve to a location in the target
                                    //!< document
  kSchemaErrorRefCyclical,          //!< $ref is cyclical
  kSchemaErrorRefNoRemoteProvider,  //!< $ref is remote but there is no remote
                                    //!< provider
  kSchemaErrorRefNoRemoteSchema,    //!< $ref is remote but the remote provider did
                                    //!< not return a schema
  ...
  kSchemaErrorSpecUnknown,          //!< JSON schema draft or OpenAPI version is not
                                    //!< recognized
  kSchemaErrorSpecUnsupported,      //!< JSON schema draft or OpenAPI version is not
                                    //!< supported
  kSchemaErrorSpecIllegal,          //!< Both JSON schema draft and OpenAPI version found
                                    //!< in document
  kSchemaErrorReadOnlyAndWriteOnly  //!< Property must not be both 'readOnly' and
                                    //!< 'writeOnly'
};
...
/*! \ingroup RAPIDJSON_ERRORS
    ...
    This is the prototype for \c GetPointerParseError_X(), where \c X is a
locale. User can dynamically change locale in runtime, e.g.: \code
    GetPointerParseErrorFunc GetPointerParseError = GetPointerParseError_En; //
