 ...
 *
 * [1] C. Akinlar and C. Topal, “EDCircles: A Real-time Circle Detector with a
 *False Detection Control,” Pattern Recognition, 46(3), 725-740, 2013.
 *
 * [2] C. Akinlar and C. Topal, “EDCircles: Realtime Circle Detection by Edge
 *Drawing (ED),” IEEE Int'l Conf. on Acoustics,  Speech, and Signal Processing
 *(ICASSP)}, March 2012.
 **************************************************************************************************************/
...
class EDCircles : public EDPF {
 ...
 private:
  ...
  static Circle* addCircle(Circle* circles, int& noCircles, double xc, double yc, double r, double circleFitError,
