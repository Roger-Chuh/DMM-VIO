...
struct RawResidualJacobian
{
	...
	Vec2f Jpdd;				// 2x1 //TODO uv对idp的雅可比[2x1] 	//!< 点对逆深度 //TODO fej, 其实逆深度每次都会重新线性化，等于没用fej

	// the two columns of d[r]/d[x,y].
	VecNRf JIdx[2];			// 9x2 //TODO 残差对uv的雅可比（梯度） //!< patch光度误差对点(gradient), 8×2 //TODO gradient, not using fej

	// = the two columns of d[r] / d[ab]
	VecNRf JabF[2];			// 9x2 //TODO 残差对ab的雅可比[1x2] //!< patch光度误差对光度仿射， 8x2 //TODO affine correction, not using fej
